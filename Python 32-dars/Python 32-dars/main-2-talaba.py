...
# Endi avvalgi darsimizda yaratgan Talaba klassimizni qaytadan 
# yartamiz.Bu safar,avvalgidan farqli ravishda,Talabani yaratishda 
# Shaxs super-klassidan foydalanamiz:
...
(f"print{talaba.get_info()}. ID raqami:{talaba.get_id()}")
...
# Kodimizni tahlil qilaylik:
    # 1-qatorda klass nomidan so'ng qavs ichida super-klass
    # nomini berdik
    # def __init__ ichida() esa klassimiz super-klassning 
    # xususiyatlarini meros olishini ko'rsatdik: super()
    # __init__()
# Yangi yaratgan Talaba klassimiz shaxs klassining barcha
# xususiyatlari va metodlariga ega bo'ladi.
talaba = Talaba("Davronbek","Atadjanov","AD001122",2005)
print(talaba.get_info())

# Talaba klassi uchun alohida get_info() metodini yozmagan bo'lsak-da
# bu metod Talabaga Shaxsdan merod o'tdi.
# Xuddi shu kabi,get_age() metodiga ham murojaat etishimiz mumkin.

print(talaba.get_age(2023))

# Dastur davomida super-klas voris klasslardan avval yozilgan
